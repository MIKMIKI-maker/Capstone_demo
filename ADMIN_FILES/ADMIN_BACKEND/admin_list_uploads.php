...
// since deactivated or deleted - excluded here so this list (and its count)
// only reflects teachers currently visible in Manage Users.
$sql = "
    ...
    INNER JOIN teacher_accounts tc ON tc.id = m.teacher_id AND tc.status = 'active'
